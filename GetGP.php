        ...
        <div class="container-fluid" style="margin-left: 26px;">
          ...
          <div class="row" style="margin-right: -794px;">
            <div class="col-md-8">
              <div class="card" >
                <div class="card-body">
                  <h5 class="card-title mb-0">GP</h5>
                </div>
                <div class="table-responsive">
                    <table id="zero_config_imp" class="table table-bordered" style="margin-left:26px;margin-right:2px;width:97%;">
                      <thead>
