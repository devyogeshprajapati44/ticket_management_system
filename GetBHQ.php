          ...
          <div class="row" style="margin-right: -794px;">
            <div class="col-md-8">
              <div class="card" style="margin-bottom: 29px;">
                <div class="card-body">
                <div class="col-12 specs_section">BHQ</div>
                </div>
                <div class="table-responsive">
                    <table id="zero_configdata" class="table table-bordered" style="margin-left:26px;margin-right:2px;width:97%;">
                      <thead>
