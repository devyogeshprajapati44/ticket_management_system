              ...
              <div class="card" style="margin-bottom: 29px;">
                ...
                <div class="table-responsive">
                 ...
                 <div id="content" style="margin-left: 306px;margin-top: 79px;display:none;">
                        <table id="districttable" style="height:300px;overflow-y: scroll; display: block; border-collapse: collapse; table-layout: fixed;width:100px;margin-left:-270px;margin-bottom:63px;">
                       <!-- Cities will be displayed here -->
                       </table>
                     </div>
                   <div id="citytable" style="margin-left:147px;margin-top: -363px;"></div>
