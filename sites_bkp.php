...
.dataTables_length{
  margin-left: 21px;
        ...
        <div class="page-breadcrumb">
          ...
          <form method="POST">
            ...
            <div class="col-12 d-flex no-block align-items-center" style="margin-left: 618px;">
              ...
              <h1 class="m-0" style="font-size:22px;"> <small>District -</small> <?php echo $DisName ?></h1>
                ...
                <div  class="box text-center" style="width:385px;">
                  ...
                  <table border="1">
                      <tr style="background-color:black;color:white;">
                          <th>Id</th>
                          <th>Segment</th>
                          <th id="total" STYLE="FONT-SIZE: 12PX;">Total Number of Devices</th>
                          <th>Status</th>
                      </tr>
                      <?php
   ...
   <div style="margin-top: -569px;">
            <!--DHQ Data--->
            <div id="content" style="margin-left: 306px;margin-top:251px;display:none;">
                        <table id="districttable"  style="height: 300px;overflow-y: scroll; display: block; border-collapse: collapse; table-layout: fixed;width:1739px;margin-left:-270px;">
                       <!-- Cities will be displayed here -->
                       </table>
                       <table id="districttable2" style="height: 300px;overflow-y: scroll; display: block; border-collapse: collapse; table-layout: fixed;width:1739px;margin-left:-270px;">
                       <!-- Cities will be displayed here -->
                       </table>
                       <table id="districttable3" style="height: 300px;overflow-y: scroll; display: block; border-collapse: collapse; table-layout: fixed;width:1739px;margin-left:-270px;">
                       <!-- Cities will be displayed here -->
                       </table>
                       <table id="districttable4" style="height: 300px;overflow-y: scroll; display: block; border-collapse: collapse; table-layout: fixed;width:1739px;margin-left:-270px;">
                       <!-- Cities will be displayed here -->
                       </table>
                     </div>
